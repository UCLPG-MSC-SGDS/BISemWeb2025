---
title: "Day 1: Introduction to Mapping in R/RStudio"
---
...
```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('images/day1/image3_path_window.png', error = FALSE) 
```
...
```{r echo=FALSE, out.width = "100%", fig.align='center', cache=TRUE,}
knitr::include_graphics('images/day1/image4_path_mac.png', error = FALSE) 
```
